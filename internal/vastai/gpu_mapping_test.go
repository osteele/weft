...
func TestResolveGPUFilter(t *testing.T) {
	tests := []struct {
		...
		{
			name:      "h100 hbm3 variant",
			gpuClass:  "H100 HBM3",
			wantNames: []string{"H100 SXM"},
		},
		{
			name:      "h100pcie variant",
			gpuClass:  "H100 PCIe",
			wantNames: []string{"H100 PCIE"},
		},
		{
...
func TestGPUClassMatchesOfferName(t *testing.T) {
	tests := []struct {
		...
		{name: "h100 accepts H100 PCIE", gpuClass: "h100", gpuName: "H100 PCIE", want: true},
		{name: "h100 accepts H100 SXM", gpuClass: "h100", gpuName: "H100 SXM", want: true},
		{name: "h100-hbm3 accepts H100 SXM", gpuClass: "h100-hbm3", gpuName: "H100 SXM", want: true},
		{name: "h100-hbm3 rejects H100 PCIE", gpuClass: "h100-hbm3", gpuName: "H100 PCIE", want: false},
		{name: "h100-pcie accepts H100 PCIE", gpuClass: "h100-pcie", gpuName: "H100 PCIE", want: true},
		{name: "h100-pcie rejects H100 SXM", gpuClass: "h100-pcie", gpuName: "H100 SXM", want: false},

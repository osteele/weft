...
func TestParseGPUConstraint(t *testing.T) {
	tests := []struct {
		...
		{"h100-pcie", constraintExactModel, GenUnknown, "h100pcie"},
		{"h100-hbm3", constraintExactModel, GenUnknown, "h100hbm3"},
...
func TestMatchesGPU(t *testing.T) {
	tests := []struct {
		...
		{"h100", "h100sxm", true},
		{"h100", "h100nvl", true},
		{"h100-pcie", "h100pcie", true},
		{"h100-pcie", "h100sxm", false},
		{"h100-sxm", "h100sxm", true},
		{"h100-sxm", "h100pcie", false},
		{"h100-hbm3", "h100sxm", true},
		{"h100-hbm3", "h100pcie", false},
		{"h100-nvl", "h100nvl", true},
		{"h100-nvl", "h100sxm", false},
...
func TestMatchesGPUFullName(t *testing.T) {
	tests := []struct {
		...
		{"h100", "NVIDIA H100 PCIe", true},
		{"h100", "NVIDIA H100 80GB HBM3", true},
		{"h100-pcie", "NVIDIA H100 PCIe", true},
		{"h100-pcie", "NVIDIA H100 SXM", false},
		{"h100-pcie", "NVIDIA H100 80GB HBM3", false},
		{"h100-sxm", "NVIDIA H100 SXM", true},
		{"h100-sxm", "NVIDIA H100 PCIe", false},
		{"h100-sxm", "NVIDIA H100 80GB HBM3", true},
		{"h100-hbm3", "NVIDIA H100 SXM", true},
		{"h100-hbm3", "NVIDIA H100 PCIe", false},
		{"h100-hbm3", "NVIDIA H100 80GB HBM3", true},
		{"h100-nvl", "NVIDIA H100 NVL", true},
		{"h100-nvl", "NVIDIA H100 SXM", false},
...
func TestSubsumes(t *testing.T) {
	tests := []struct {
		...
		{"h100", "h100-sxm", true},
		{"h100", "h100-hbm3", true},
		{"h100-pcie", "h100", false},
		{"h100-pcie", "h100-sxm", false},
		{"h100-sxm", "h100-hbm3", true},
		{"h100-hbm3", "h100-sxm", true},

...
var defaultJSONColumnKeys = []string{"id", "job_id", "host", "status", "status_code", "started", "project", "dir", "description", "command", "exit_code", "duration", "tags", "gpu", "submitter_session"}

...
func TestBootstrapStageLabel(t *testing.T) {
	tests := []struct {
		...
		{"hf_tool_installing", "installing HF download tool"},
		{"hf_tool_installed", "HF download tool installed"},
		{"downloading_models:2/5", "downloading models (2/5)"},
		{"downloading_hf:1/2", "downloading HF assets (1/2)"},
		{"failed:127", "bootstrap failed (127)"},

...
func killJobWithService(svc *core.Service, jobID int64, mode ops.TimeoutMode, attribution ops.StopAttribution) (core.OperationResult, error) {
	if svc != nil {
		return svc.KillJob(jobID, mode, attribution)
	}
	...
	defer temp.Close()
	return temp.KillJob(jobID, mode, attribution)
}
